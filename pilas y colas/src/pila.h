...
struct Pila //estructura creada para crear vraiables en el programa principal
{
		...
		Letra *top = NULL;
		Letra *auxiliar = NULL;
		Letra *abajopila = NULL;                 // los 4 anterios son punteros para manipular los datos en las funciones que estan mas adelante


			void Pushpila (string x)   //funcion push para insertar caracteres
			{
			...
			void Toppila () //funcion top para mostrar el dato que esta de primero en los datos almacenados.
			{
				...
				{
					cout<<"\t el top de la Pila es: "<<top->caracter<<endl;

				}
			}

			void Poppila() //metodo para eliminar el caracter que esta en el puntero top
			{
				if(top == NULL) //mensaje de devolucion en caso de que aun no exista algun nodo
				{
			...
			void Imprimirpila() // metodo para mostrar todos los datos que se encuentran en la estructura.
			{
				auxiliar = top;
			...
			void Listavaciapila() // funcion para verificar si la lista esta vacia
			{
			...
			void tamaniopila ()//funcion para verificar el tamanio de la lista
			{
				auxiliar = top;
				int i = 0;
				if(top==NULL) //mensaje de devolucion en caso de que aun no exista algun nodo
				{
					cout<<"El tamaño de la Lista de pila es: "<< i <<endl;
					cout<<"-----------------------------\n\n\n";
				}
				else
				{
					...
					{
						i++; //aumentar i para contar el numero de caracteres existentes
						auxiliar = auxiliar->siguiente;
					}
				cout<<"El tamaño de la Lista de pila es: "<< i <<endl;
				cout<<"-----------------------------\n\n\n";
